...
var App = angular.module('mainApp', ['ui.router']).run(function ($rootScope) {
  ...
  loadJSON(function (response) {
    ...
    $rootScope.apiHost = config.apiUrl
  });
...
App.config(function ($stateProvider, $urlRouterProvider) {
  ...
  $stateProvider
    ...
    .state('forgetpassword', {
      url: '/forgetpassword',
      templateUrl: 'app/components/loggedOut/forgetpassword/forgetPassword.html',
    ...
    .state('createNewSellListing_Step-1', {
      ...
      controller: 'createNewSellListing_Step-1Controller'
    })
  ...
  return {
    ...
    link: function (scope, element, attr, mCtrl) {
      function myValidation(value) {
        if (value.indexOf("0x") > -1 && value.length == 42) {
